  ...
  return (
    <Paper className = "paper">
      <form autoComplete = "off" Validate className = 'form' onSubmit = {handleSubmit}>
        ...
        <TextField className = 'input' name = "content" variant = "outlined"  label = "Content"  fullWidth value = {listData.content} onChange = {(e) => setListData({...listData, content: e.target.value})}/>
